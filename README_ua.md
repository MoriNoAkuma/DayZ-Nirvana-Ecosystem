...
### Функції Discord-бота
- Бот, який показує онлайн сервера, серверний час та час до наступного рестарту.
- Система тікетів, тікети гравців зберігаються в discord-каналі, де ви можете переглянути їх пізніше, нагадування про неприйнятий тікет, 
  система прийняття тікетів для адмінів, система рейтингу роботи адмінів, модальні вікна які можна редагувати для системи тікетів.
- Таблиці лідерів у discord, вбивства, ігровий час, найдовший постріл
- Discord-магазин, що має спільні товари з веб-магазином.
- Автоматичне привітання користувачів та автоматичні ролі.
- Кіл-фід з налаштовуваним текстом.
